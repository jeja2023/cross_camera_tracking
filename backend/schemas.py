...
# 新增 ModelConfig 模型，用于表示所有可配置的系统参数
class ModelConfig(BaseModel):
    ...
    # 流日志间隔帧数
    STREAM_LOG_INTERVAL_FRAMES: Optional[int] = Field(100, description="流日志间隔帧数")
    ...
    REALTIME_COMPARISON_MAX_FOLLOWED_PERSONS: Optional[int] = Field(100, description="实时比对最大关注人数")
    GLOBAL_SEARCH_MIN_CONFIDENCE: Optional[float] = Field(0.9, description="全局搜索最小置信度") # 新增
